...
uniform sampler2D u_texture; //texure to be applied to billboard quad
...
void main(void) {
	...
	avgColor = texture2D(u_texture, texCoords[0]) +
				texture2D(u_texture, texCoords[1]) +
				texture2D(u_texture, texCoords[2]) +
				texture2D(u_texture, texCoords[3]) +
				texture2D(u_texture, texCoords[4]) +
				texture2D(u_texture, texCoords[5]) +
				texture2D(u_texture, texCoords[6]) +
				texture2D(u_texture, texCoords[7]) +
				texture2D(u_texture, texCoords[8]);
